...
public class FoundationsModesPage extends AbstractPage
{
    ...
    public FoundationsModesPage(String title)
    {
        super(title);

        //        ###############################################################################################
        String[][] intro = {{"Foundation modes  "},
                {""},
                {"As seen in the Place Mode intro page you can select a foundation by clicking on the HUD overlay button on the right."},
        ...
        Paragraph.KeyInformation[] keys1 = {
                new Paragraph.KeyInformation(keybindings1, "Toggle Foundation Mode")};

        Paragraph para1 = new Paragraph(startX, 50, paraWidth + (200 - startX), null, "mp4", keys1, "Intro Foundations Modes", intro, mc.getResourceManager());

        //        ###############################################################################################
        String[][] perspective1 = {{"The NO FOUNDATION setting allows you to place a template without any added foundation blocks added."}
        };
        ...
        Paragraph para2 = new Paragraph(startX, 50, paraWidth + (200 - startX), "single", "mp4", keys2, "No Foundation", perspective1, mc.getResourceManager());
        ...
        Paragraph para3 = new Paragraph(startX, 50, paraWidth + (200 - startX), "line", "mp4", keys3, "LINE Tool", perspective2, mc.getResourceManager());
        ...
        Paragraph para4 = new Paragraph(startX, 50, paraWidth + (200 - startX), "rectangle", "mp4", keys4, "RECTANGLE Tool", firstPerson, mc.getResourceManager());
        ...
        Paragraph para5 = new Paragraph(startX, 50, paraWidth + (200 - startX), "curve", "mp4", keys5, "CURVE Tool", curve, mc.getResourceManager());
        ...
        Paragraph para6 = new Paragraph(startX, 50, paraWidth + (200 - startX), "circle", "mp4", keys6, "CIRCLE Tool", circle, mc.getResourceManager());
        ...
        Paragraph para7 = new Paragraph(startX, 50, paraWidth + (200 - startX), "pull", "mp4", keys7, "PULL Tool", pull, mc.getResourceManager());
        ...
        Paragraph para8 = new Paragraph(startX, 50, paraWidth + (200 - startX), "copy", "mp4", keys8, "COPY Tool", copy, mc.getResourceManager());
        ...
        Paragraph para9 = new Paragraph(startX, 50, paraWidth + (200 - startX), "move", "mp4", keys9, "MOVE/DEL Tool", move, mc.getResourceManager());
        ...
        Paragraph para10 = new Paragraph(startX, 50, paraWidth + (200 - startX), "adjust", "mp4", keys10, "Adjust COPY/MOVE area", adjust, mc.getResourceManager());
        ...
        Paragraph para11 = new Paragraph(startX, 50, paraWidth + (200 - startX), "fillgap", "mp4", keys11, "FILLGAP Tool", fillGap, mc.getResourceManager());
