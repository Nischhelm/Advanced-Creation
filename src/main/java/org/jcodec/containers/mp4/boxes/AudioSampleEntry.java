...
public class AudioSampleEntry extends SampleEntry {
    ...
    public ByteOrder getEndian() {
        EndianBox endianBox = findFirstPath(this, EndianBox.class, new String[] { WaveExtension.fourcc(), EndianBox.fourcc() });
        if (endianBox == null) {
    ...
    public ChannelLabel[] getLabels() {
        ChannelBox channelBox = findFirst(this, ChannelBox.class, "chan");
        if (channelBox != null) {
    ...
    public static Label[] getLabelsFromSampleEntry(AudioSampleEntry se) {
        ChannelBox channel = findFirst(se, ChannelBox.class, "chan");
        if (channel != null)
    ...
    public static void _setLabels(TrakBox trakBox, Label[] labels) {
        ChannelBox channel = findFirstPath(trakBox, ChannelBox.class, new String[] { "mdia", "minf", "stbl", "stsd", null, "chan" });
        if (channel == null) {
            channel = ChannelBox.createChannelBox();
            findFirstPath(trakBox, SampleEntry.class, new String[] { "mdia", "minf", "stbl", "stsd", null }).add(channel);
        }
