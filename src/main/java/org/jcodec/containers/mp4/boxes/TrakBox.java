...
public class TrakBox extends NodeBox {
    ...
    public List<Edit> getEdits() {
        EditListBox elst = findFirstPath(this, EditListBox.class, path("edts.elst"));
        if (elst == null)
            return null;
    ...
    public String getHandlerType() {
        HandlerBox handlerBox = findFirstPath(this, HandlerBox.class, path("mdia.hdlr"));
        if (handlerBox == null)
            return null;
    ...
    public int getTimescale() {
        return findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd")).getTimescale();
    }
    ...
    public void setTimescale(int timescale) {
        findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd")).setTimescale(timescale);
    }
    ...
    public long getMediaDuration() {
        return findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd")).getDuration();
    }
    
    public void setMediaDuration(long duration) {
        findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd")).setDuration(duration);
    }
    ...
    public Rational getPAR() {
        PixelAspectExt pasp = findFirstPath(this, PixelAspectExt.class, new String[] { "mdia", "minf", "stbl", "stsd", null, "pasp" });
    ...
    public SampleEntry[] getSampleEntries() {
        return findAllPath(this, SampleEntry.class, new String[]{"mdia", "minf", "stbl", "stsd", null});
    }

    public void setClipRect(short x, short y, short width, short height) {
        NodeBox clip = findFirst(this, NodeBox.class, "clip");
        if (clip == null) {
    ...
    public long getSampleCount() {
        return findFirstPath(this, SampleSizesBox.class, path("mdia.minf.stbl.stsz")).getCount();
    }
    ...
    public int getFrameCount() {
        SampleSizesBox stsz = findFirstPath(this, SampleSizesBox.class, path("mdia.minf.stbl.stsz"));
        return stsz.getDefaultSize() != 0 ? stsz.getCount() : stsz.getSizes().length;
    }

    public String getName() {
        NameBox nb = findFirstPath(this, NameBox.class, path("udta.name"));
        return nb == null ? null : nb.getName();
    }

    public void fixMediaTimescale(int ts) {
        MediaHeaderBox mdhd = findFirstPath(this, MediaHeaderBox.class, path("mdia.mdhd"));
        ...
        TimeToSampleBox tts = findFirstPath(this, TimeToSampleBox.class, path("mdia.minf.stbl.stts"));
    ...
    public TimeToSampleBox getStts() {
        return findFirstPath(this, TimeToSampleBox.class, path("mdia.minf.stbl.stts"));
    }

    public ChunkOffsetsBox getStco() {
        return findFirstPath(this, ChunkOffsetsBox.class, path("mdia.minf.stbl.stco" ));
    }

    public ChunkOffsets64Box getCo64() {
        return findFirstPath(this, ChunkOffsets64Box.class, path("mdia.minf.stbl.co64" ));
    }

    public SampleSizesBox getStsz() {
        return findFirstPath(this, SampleSizesBox.class, path("mdia.minf.stbl.stsz" ));
    }
    public NodeBox getStbl() {
        return findFirstPath(this, NodeBox.class, path("mdia.minf.stbl" ));
    }

    public SampleToChunkBox getStsc() {
        return findFirstPath(this, SampleToChunkBox.class, path("mdia.minf.stbl.stsc" ));
    }

    public SampleDescriptionBox getStsd() {
        return findFirstPath(this, SampleDescriptionBox.class, path("mdia.minf.stbl.stsd" ));
    }

    public SyncSamplesBox getStss() {
        return findFirstPath(this, SyncSamplesBox.class, path("mdia.minf.stbl.stss" ));
    }

    public CompositionOffsetsBox getCtts() {
        return findFirstPath(this, CompositionOffsetsBox.class, path("mdia.minf.stbl.ctts" ));
    }
    
    public static MP4TrackType getTrackType(TrakBox trak) {
        HandlerBox handler = findFirstPath(trak, HandlerBox.class, path("mdia.hdlr"));
